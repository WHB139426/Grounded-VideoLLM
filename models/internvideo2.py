...
# state_dict = torch.load('/data3/whb/weights/internvideo/vision-InternVideo2-stage2_1b-224p-f4.pt', map_location='cpu')
# new_state_dict = {}
# for key, value in state_dict.items():
#     if 'vision_encoder.' in key:
#         new_key = key.replace('vision_encoder.', '')
#         new_state_dict[new_key] = value
# torch.save(new_state_dict, '/data3/whb/weights/internvideo/vision-encoder-InternVideo2-stage2_1b-224p-f4.pt')



# num_frames = 16
# model = pretrain_internvideo2_1b_patch14_224(num_frames)
# state_dict = torch.load('/data3/whb/weights/internvideo/vision-encoder-InternVideo2-stage2_1b-224p-f4.pt', map_location='cpu')
# interpolate_pos_embed_internvideo2_new(state_dict, model, orig_t_size=4)

# model.load_state_dict(state_dict, strict=True)

# image = torch.randn(2, num_frames, 3, 224, 224)
# image = image.permute(0, 2, 1, 3, 4)  # [B,T,C,H,W] -> [B,C,T,H,W]
# print(image.shape)
# vision_embeds = model(image, None, False, x_vis_return_idx=-2, x_vis_only=True)
