...
class ANet_Caption(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/activitynet/captions/train.json",
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/activitynet-dense-caption.json')
...
class ANet_RTL(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/activitynet/activitynet_train_gpt-4-0613_temp_6_f10009.json",
        video_path = '/home/haibo/data/activitynet/videos',
        num_frames = 96,
        num_segs = 12,
        num_temporal_tokens = 300,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/ANet_RTL.json')
...
class VCG_Plus_112k(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/activitynet/videos",
        anno_path = '/home/haibo/data/activitynet/vcg-plus_112K.json',
        num_frames = 128,
        num_segs = 16,
        num_temporal_tokens = 300,
        sample='rand',
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/vcg_plus_112k.json')
...
class VideochatGPT100K(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/activitynet/videos",
        anno_path = '/home/haibo/data/activitynet/VideoInstruct_Dataset.json',
        num_frames = 128,
        num_segs = 16,
        num_temporal_tokens = 300,
        sample='rand',
        ...
        #             'video_file': 'activitynet/videos/'+item['video_id']+'.mp4',
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/videochatgpt-100k.json')
...
# dataset = VideochatGPT100K(llm='llama3')
# for i in range(10):
#     entry = random.choice(dataset)
#     print(entry['question_ids'], entry['video_ids'])
#     print("text_inputs: ",             entry['text_inputs'])
