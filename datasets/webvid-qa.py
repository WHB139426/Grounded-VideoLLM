...
def filter_unexist(data, file_path='/data/hvw5451/data/webvid-qa/videos'):
...
# data = load_json('/data/hvw5451/data/webvid-qa/filtered_train.json')
# fiter_files = filter_unexist(data)
# print(len(data), len(fiter_files))

class WebVid_QA(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/webvid-qa/videos",
        anno_path = '/data/hvw5451/data/webvid-qa/filtered_train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #             'video_file': 'webvid-qa/videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/webvid-qa.json')
