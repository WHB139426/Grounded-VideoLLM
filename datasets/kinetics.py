...
class Kinetics(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/kinetics/videos",
        anno_path = '/home/haibo/data/kinetics/filtered_train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/kinetics.json')
