...
class TextVR(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/TextVR/videos",
        anno_path = '/data/hvw5451/data/TextVR/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #             'video_file': 'TextVR/videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/TextVR.json')
