...
def filter_unexist(data, file_path='/data/hvw5451/data/webvid-caption/videos'):
...
# data = load_json('/data/hvw5451/data/webvid-caption/filtered_train.json')
# fiter_files = filter_unexist(data)
# save_json(fiter_files, '/data/hvw5451/data/webvid-caption/filtered_train.json')
# print(len(data), len(fiter_files))

class WebVid_Caption(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/webvid-caption/videos",
        anno_path = '/data/hvw5451/data/webvid-caption/filtered_train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #             'video_file': 'webvid-caption/videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/webvid-caption.json')
