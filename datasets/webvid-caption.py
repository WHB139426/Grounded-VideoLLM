...
def filter_unexist(data, file_path='/home/haibo/data/webvid-caption/videos'):
...
# data = load_json('/home/haibo/data/webvid-caption/filtered_train.json')
# fiter_files = filter_unexist(data)
# save_json(fiter_files, '/home/haibo/data/webvid-caption/filtered_train.json')
# print(len(data), len(fiter_files))

class WebVid_Caption(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/webvid-caption/videos",
        anno_path = '/home/haibo/data/webvid-caption/filtered_train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/webvid-caption.json')
