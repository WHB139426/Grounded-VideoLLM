...
def filter_unexist(data, file_path='/home/haibo/data/VTG-IT/videos'):
...
# data = load_json('/home/haibo/data/VTG-IT/dense_video_caption.json')
# filter_data = filter_unexist(data)
# print(len(data), len(filter_data))
# print(filter_data[0])
# save_json(filter_data, '/home/haibo/data/VTG-IT/train.json')


class VTG_IT(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/VTG-IT/train.json",
        video_path = '/home/haibo/data/VTG-IT/videos',
        num_frames = 96,
        num_segs = 12,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/VTG-IT.json')
