...
# data = load_json('/home/haibo/data/Moment-10m/simplified_Moment_10M.json')
...
# print(len(new_data))
# save_json(new_data, '/home/haibo/data/Moment-10m/less_simplified_Moment_10m.json')
...
class Moment_10m(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/Moment-10m/less_simplified_Moment_10m.json",
        video_path = "/home/haibo/data/Moment-10m/videos",
        num_frames = 96,
        num_segs = 12,
        num_temporal_tokens = 300,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/Moment-10m.json')
