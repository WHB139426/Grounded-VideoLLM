...
class VideoChat2_Conversations(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/videochat2_conversations/videos",
        anno_path = '/home/haibo/data/videochat2_conversations/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/videochat2_conversations.json')
