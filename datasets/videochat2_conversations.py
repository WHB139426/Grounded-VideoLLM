...
class VideoChat2_Conversations(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/videochat2_conversations/videos",
        anno_path = '/data/hvw5451/data/videochat2_conversations/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #             'video_file': 'videochat2_conversations/videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/videochat2_conversations.json')
...
# dataset = VideoChat2_Conversations()
# for i in range(10):
