...
def filter_unexist(data, file_path='/home/haibo/data/vitt/videos'):
    ...
    for item in data:
        ...
        for anno in item['annotations']:
            captions.append(anno['tag'])
            timestamps.append(anno['timestamp']/1000.0)
        if f'{video_id}.mp4' in exist_files and video_id in train_ids:
            fiter_files.append({
                "video_id": video_id,
                "captions": captions,
...
# data = load_jsonl('/home/haibo/data/vitt/ViTT-annotations.json')
# train_ids = load_txt('/home/haibo/data/vitt/train_id.txt')
# filter_data = filter_unexist(data)
# print(filter_data[0], len(filter_data))
# save_json(filter_data, '/home/haibo/data/vitt/train.json')

# data = load_json('/home/haibo/data/vitt/train.json')
# for item in data:
#     if len(item['captions']) != len(item['timestamps']):
#         print(item)
#     if '' in item['captions']:
#         print(item)
...
class ViTT(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/vitt/train.json",
        video_path = '/home/haibo/data/vitt/videos',
        num_frames = 96,
        num_segs = 12,
        ...
        for item in self.data:
            ...
            instruction = random.choice(dense_caption_prompts_one_end_short)
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/ViTT.json')
