...
class CLEVRER(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/clevrer/videos",
        anno_path_qa = '/data/hvw5451/data/clevrer/train_qa.json',
        anno_path_mc = '/data/hvw5451/data/clevrer/train_mc.json',
        num_frames = 128,
        num_segs = 16,
        ...
        self.data = load_json(anno_path_qa) + load_json(anno_path_mc)
        if llm == 'llama3':
        ...
        #             'video_file': 'clevrer/videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/clevrer.json')
