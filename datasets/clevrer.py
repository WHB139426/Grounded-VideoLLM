...
class CLEVRER(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/clevrer/videos",
        anno_path_qa = '/home/haibo/data/clevrer/train_qa.json',
        anno_path_mc = '/home/haibo/data/clevrer/train_mc.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/clevrer.json')
