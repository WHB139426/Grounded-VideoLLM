...
class SthSthV2(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/sthsthv2/videos",
        anno_path = '/data/hvw5451/data/sthsthv2/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #             'video_file': 'sthsthv2/videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/sthsthv2.json')
