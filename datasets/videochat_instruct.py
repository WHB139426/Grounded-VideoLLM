...
# def filter_unexist(data, file_path='/data/hvw5451/data/VideoChat_instruct/videos'):
...
# data = load_json('/data/hvw5451/data/VideoChat_instruct/filtered_videochat_instruct_11k.json')
...
class VideoChat_Instruct(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/VideoChat_instruct/videos",
        anno_path = '/data/hvw5451/data/VideoChat_instruct/filtered_videochat_instruct_11k.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/videochat_instruct.json')
