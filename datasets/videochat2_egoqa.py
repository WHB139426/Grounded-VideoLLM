...
class VideoChat2_EgoQA(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/videochat2_egoqa/videos",
        anno_path = '/home/haibo/data/videochat2_egoqa/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #             }
        #         )
        # save_json(save_files, '/home/haibo/data/mix_sft/videochat2_egoqa.json')
