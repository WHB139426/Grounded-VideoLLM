...
class NEXTQA(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/nextqa/videos",
        anno_path = '/data/hvw5451/data/nextqa/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/nextqa.json')
...
# mapper = load_json('/data/hvw5451/data/nextqa/map_vid_vidorID.json')
# data = load_csv('/data/hvw5451/data/nextqa/intentqa_train.csv')
# train_intentqa = []
# for item in data:
...
#         'QA': QA
#     })
# save_json(train_intentqa, '/data/hvw5451/data/nextqa/train_intentqa.json')
...
class IntentQA(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/nextqa/videos",
        anno_path = '/data/hvw5451/data/nextqa/train_intentqa.json',
        num_frames = 128,
        num_segs = 16,
        num_temporal_tokens = 300,
        sample='rand',
        ...
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/intentqa.json')
