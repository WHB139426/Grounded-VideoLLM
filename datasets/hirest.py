...
# def filter_unexist_grounding(data, file_path='/home/haibo/data/HiREST/videos'):
...
# def filter_unexist_step(data, file_path='/home/haibo/data/HiREST/videos'):
#     exist_files = os.listdir(file_path)
#     fiter_files = []
#     for item in data:
...
# data_grounding = load_json('/home/haibo/data/HiREST/data_temporal_video_grounding_hirest_instruct_tvg_0.5k_hirest.json')
...
# data_step = load_json('/home/haibo/data/HiREST/timeit_hirest_step_instruct_action_0.5k_hirest.json')
...
# save_json(filter_data, '/home/haibo/data/HiREST/train.json')

class HiREST(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/HiREST/train.json",
        video_path = '/home/haibo/data/HiREST/videos',
        num_frames = 96,
        num_segs = 12,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/HiREST.json')
