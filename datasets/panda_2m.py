...
# def filter_unexist(data, file_path='/home/haibo/data/panda70m_2m/clips'):
...
# data = load_json("/home/haibo/data/panda70m_2m/filtered_panda.json")
# fiter_files = filter_unexist(data)
# save_json(fiter_files, "/home/haibo/data/panda70m_2m/simplified_panda.json")
# print(len(data), len(fiter_files))

class Panda_2m(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/panda70m_2m/simplified_panda.json",
        video_path = "/home/haibo/data/panda70m_2m/clips",
        num_frames = 128,
        num_segs = 16,
