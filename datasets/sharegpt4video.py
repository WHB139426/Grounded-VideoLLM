...
class ShareGPT4Video(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/sharegpt4video/videos",
        anno_path = '/data/hvw5451/data/sharegpt4video/sharegpt4video_40k.jsonl',
        num_frames = 128,
        num_segs = 16,
        ...
        for item in self.data:
            ...
            instruction = random.choice(detail_caption_prompts)
            answer = item['captions'][-1]['content']
        ...
        #             'video_file': 'sharegpt4video/videos/'+item['video_path'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/sharegpt4video.json')
...
# dataset = ShareGPT4Video(llm='llama3')
# for i in range(10):
