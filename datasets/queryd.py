...
# data_captions = load_pkl('/home/haibo/data/querYD/raw_captions_combined_filtered.pkl')
# data_time = load_pkl('/home/haibo/data/querYD/times_captions_combined_filtered.pkl')
# new_data = []
...
#         )
# print(len(new_data))
# save_json(new_data, '/home/haibo/data/querYD/train.json')

# def filter_unexist(data, file_path='/home/haibo/data/querYD/videos'):
...
# data = load_json('/home/haibo/data/querYD/train.json')
# print(len(data))
# filter_data = filter_unexist(data)
# print(len(filter_data))
# save_json(filter_data, '/home/haibo/data/querYD/filter_train.json')

class querYD(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/querYD/filter_train.json",
        video_path = '/home/haibo/data/querYD/videos',
        num_frames = 96,
        num_segs = 12,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/querYD.json')
