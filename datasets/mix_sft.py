...
#     data = load_json(f'/home/haibo/data/mix_sft/{key}.json')
#     print(key, len(data))
...
# print()
# save_json(mix_sft_grounding, '/home/haibo/data/mix_sft/mix_sft_grounding.json')
...
# print()
# save_json(mix_sft_instruction, '/home/haibo/data/mix_sft/mix_sft_instruction.json')

# mix_sft = mix_sft_instruction + mix_sft_grounding
# print('mix_sft', len(mix_sft))
# save_json(mix_sft, '/home/haibo/data/mix_sft/mix_sft.json')


missing = []
video_nums = []
data = load_json("/home/haibo/data/mix_sft/mix_sft.json")
def filter_unexist(data, file_path='/home/haibo/data'):
