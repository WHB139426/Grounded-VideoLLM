...
def filter_unexist(data, file_path='/home/haibo/data/coin/videos'):
...
# data = load_json('/home/haibo/data/coin/COIN.json')['database']
# filter_data = filter_unexist(data)
# print(len(list(data.keys())))
# print(len(filter_data))
# save_json(filter_data, '/home/haibo/data/coin/train.json')

class COIN(Dataset):
    def __init__(
        self,
        anno_path = "/home/haibo/data/coin/train.json",
        video_path = '/home/haibo/data/coin/videos',
        num_frames = 96,
        num_segs = 12,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/COIN.json')
