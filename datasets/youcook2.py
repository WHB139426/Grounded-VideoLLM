...
class Youcook2(Dataset):
    def __init__(
        self,
        video_path = "/home/haibo/data/youcook2/youcook_split_videos",
        anno_path = '/home/haibo/data/youcook2/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        #         }
        #     )
        # save_json(save_files, '/home/haibo/data/mix_sft/youcook2.json')
