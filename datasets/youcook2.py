...
class Youcook2(Dataset):
    def __init__(
        self,
        video_path = "/data/hvw5451/data/youcook2/youcook_split_videos",
        anno_path = '/data/hvw5451/data/youcook2/train.json',
        num_frames = 128,
        num_segs = 16,
        ...
        for item in self.data:
            self.question_ids.append(item['video'].split('.')[0])
            self.video_files.append(item['video'])
            self.video_ids.append(item['video'].split('.')[0])
            conversations = []
            ...
            conversations[1]['value'] = conversations[1]['value'][0].upper() + conversations[1]['value'][1:] + '.'
        ...
        #             'question_id': item['video'].split('.')[0],
        #             'video_file': 'youcook2/youcook_split_videos/'+item['video'],
        #             'conversation': conversations
        #         }
        #     )
        # save_json(save_files, '/data/hvw5451/data/mix_sft/youcook2.json')
