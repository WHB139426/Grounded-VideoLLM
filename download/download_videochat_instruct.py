...
packed_data = load_json('/data3/whb/data/VideoChat_instruct/filtered_videochat_instruct_11k.json')
video_path = "/data3/whb/data/VideoChat_instruct/videos/"
...
# nohup python download_videochat_instruct.py > download_videochat_instruct.out 2>&1 &    1452390