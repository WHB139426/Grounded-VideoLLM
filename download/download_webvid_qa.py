...
packed_data = load_json('/data3/whb/data/webvid-qa/filtered_train.json')
video_path = "/data3/whb/data/webvid-qa/videos/"
...
# nohup python download_webvid_qa.py > download_webvid_qa.out 2>&1 &          996455  