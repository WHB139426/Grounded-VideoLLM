...
def process_video(item, video_path, clip_path):
    ...
    if os.path.exists(file_path):
        try:
            ...
            timestamp = item["meta"]["split"]

            start_time = max(0, timestamp[0])
...
def main():
    packed_data = load_json('/data3/whb/data/vtimellm_stage2/stage2.json')
    video_path = '/data3/whb/data/vtimellm_stage2/videos'
    clip_path = '/data3/whb/data/vtimellm_stage2/clips'
    missing_urls = []
...
# nohup python download_vtimellm.py > download_vtimellm.out 2>&1 &    4193220